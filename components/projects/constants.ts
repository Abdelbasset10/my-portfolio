export const projects = [
    ...
    // },
    {
      ...
      skills:["React Native","React Navigation","Redux toolkit","Sanity"],
      image:"/image/deliveroo.jpg", 
      github:"https://github.com/Abdelbasset10/Deliveroo2.0-Clone",
      production:""
    },
    {
      title:"System des gestions des PFES",
      dec:"Web application for university where the student can search for binome and superviser and also subject proposed by teachers or companies, and also can discuss with them in real time inside the platform",
      skills:["React","Vite","Redux Toolkit","ExpressJs","MongoDB","Socket io"],
      image:"/image/pfe.png", 
      github:"https://github.com/Abdelbasset10/PFE",
      production:""
    },
    {   
